...
<section id="content">
<form name="myForm" action="<%=request.getContextPath()%>/PoliceStation" >	

<h1>View Police Station Details</h1>

<div style="position:relative;width:600px;height:375px;">

<div style="position: relative;top: -15px;left: 325px;">
		<input type="submit" name="action" value="Add Police"  id="button" style="width:100px; "/>&nbsp;&nbsp;
	<input type="submit" name="action" value="Edit Police"  id="button" style="width:100px; "/>
	<input type="submit" name="action" value="Delete Police" id="button" style="width:100px;"/>
</div>
...
%>
		<div class="success" id="message" style="position:absolute;top:421px;left:11px">	
			<p>Police Station Details Deleted Successfully.....!</p>
		</div>
<%
	}
...
%>
		<div class="success" id="message" style="position:absolute;top:421px;left:11px">	
			<p>Police Station Details Updated Successfully....!</p>
		</div>
<%
	}
