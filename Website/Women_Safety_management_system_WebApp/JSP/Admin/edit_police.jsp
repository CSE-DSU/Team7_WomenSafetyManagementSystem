...
<section id="content" style="position: absolute;top:15;left:190px;">
	<form name="frm" action="<%=request.getContextPath()%>/PoliceStation">
	...
	<table style="width: 500px;text-align: center;">
		...
		<tr align="center">
			...
			<td>
					<input type="text" name="police_station_name"  value="<%=police_station_name%>" class="easyui-validatebox" required="required" autofocus required  title="Please,Enter The Land Mark".readonly/>
			</td>
