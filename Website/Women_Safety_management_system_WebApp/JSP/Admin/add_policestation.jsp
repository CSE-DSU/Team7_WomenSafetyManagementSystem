...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBNsS6JCRbPQ4LIY2fZjLiTNZ6SHOkbWBo&callback=initMap"
...
--%>
	...
	<form name="frm" action="<%=request.getContextPath()%>/PoliceStation" method="get">
			
	<h1>Police Station</h1>
	<table style="width: 500px;text-align: center;">
		<tr align="center">
	        <td>
	        		Police Station Name:<font color="red" size="4">*</font>
	        </td>
	        
	        <td width="11px">:</td>
	        
			<td>
					<input type="text" name="police_station_name"  placeholder="Enter The Police station Name" class="easyui-validatebox"   required="required" title="Please,Enter The Police station name."/>
			</td>
		...
		<tr align="center">
				<td colspan="3" align="center">
						<input  type="submit" name="action" value="Add Police" style="left:190px;width: 150px;"/>
...
%>
		<div class="info" id="message" style="position:absolute;top:421px;left:11px">	
			<p>Police Station Details Added Successfully......</p>
		</div>			
<%
	}
