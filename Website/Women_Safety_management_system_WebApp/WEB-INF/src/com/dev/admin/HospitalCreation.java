...
public class HospitalCreation extends HttpServlet {
	...
	public void doGet(HttpServletRequest request,HttpServletResponse response)throws IOException
	{
		...
		String Hospital_name="",Address1="",Address2="",Area="",city="",state="",pin="",land_line="",cell_no1="",cell_no2="",remarks="",latitude="",logitude="";
		...
		try{
		   ...
		   if(submit.equals("Add Hospital"))
		   {
			...
			if(!flag)
			{
				flag = AdminDAO.addhospital(Hospital_name, Address1, Address2, Area, city, state, pin, land_line, cell_no1, cell_no2, remarks, latitude, logitude);
				if(flag)
				{
					rs=AdminDAO.getHospital();
					request.setAttribute("rs", rs);
