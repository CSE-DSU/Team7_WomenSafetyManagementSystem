...
<center>
 <%--  <img src="<%=request.getContextPath()%>/res/Images/Women.png" width="1024" height="80"  alt=""/>  --%>
 <strong><h1 style="width:100%; font-size:500%;color:white;text-align:center;color:black;">Women Safety Management System</h1></strong>
...
<%-- Admin Login (Starts) --%>
	<div class="container" style="position:absolute;top:150px;left:30px;">
			 <!-- Codrops top bar -->
                           ...
                           <div id="boxForm">
                           <h2 style="font-family:'Montserrat', sans-serif; text-align:center;"> Admin Login Page </h2>
