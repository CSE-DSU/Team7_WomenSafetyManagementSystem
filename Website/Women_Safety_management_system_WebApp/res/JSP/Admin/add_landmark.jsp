...
--%>
	...
	<table style="width: 500px;text-align: center;">
		...
		<tr align="center">
			...
			<td>
					<input type="text" name="cell_no1"  placeholder="Enter The mobile number" class="easyui-validatebox"   required="required" title="Please,Enter The State."/>
		...
		<tr align="center">
			...
			<td>
					<input type="text" name="cell_no2"  placeholder="Enter The mobile number" class="easyui-validatebox"   required="required" title="Please,Enter The State."/>
